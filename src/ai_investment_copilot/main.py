...
from ai_investment_copilot.build_digest import build_digest, build_discord_digest_messages, save_digest
...
def main() -> None:
    """Run the daily market digest pipeline."""
    load_dotenv()
    ...
    if webhook_url:
        ...
        for discord_markdown in build_discord_digest_messages(ranked_news, price_moves):
